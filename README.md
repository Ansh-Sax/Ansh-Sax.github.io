...
The idea for the "Blog" tab is to link each note / writing to a pdf living in the "notes" repository, which will in turn be locally editable using my personal computers via VSCode, through jsDelivr service which opens the pdf as if it was being natively hosted (i.e., without the github pdf viewer interface; for more on this see below).
...
<!-- Note 1 -->
            <div class="blog-entry">
                <div class="blog-title">
                    ...
                    1. <a href="https://cdn.jsdelivr.net/gh/Ansh-Sax/notes@main/YM_Learning_Seminar_SSZ_Part_II/YM_Learning_Seminar_SSZ_Part_II.pdf" target="_blank">Yang-Mills Learning Seminar: Shen-Zhu-Zhu ’22, Part II</a>
                </div>
                <div class="blog-desc">
